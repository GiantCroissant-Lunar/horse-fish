...
// Agent: pi-sqlite-persist | Capability: builder
//
...
const AGENT_NAME = "pi-sqlite-persist";
const WORKTREE_PATH = "/Users/apprenticegc/Work/lunar-horse/yokan-projects/horse-fish/.overstory/worktrees/pi-sqlite-persist";
...
export default function (pi: ExtensionAPI) {
	...
	pi.on("tool_call", async (event) => {
		...
		// 3. Path boundary enforcement for write/edit tools (all agents).
